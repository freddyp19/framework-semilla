					...
					<td>
						<div align="center">
							<table width="830" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="0">
										<img src="/<?php echo $sistema; ?>/vista/layouts/<?php echo $defaul_layouts; ?>/imagenes/iconos/imagen_superior_menu.gif" width="0" height="27">
									</td>
								...
								<tr>
									...
									<td width="0" valign="top" bgcolor="#e8e8e8">
