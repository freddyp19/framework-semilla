...
<div id="right">
	<div id="rightpad">
		<div id="step">
			...
			<h2>Extras para Postgres (Opcional)</h2>
		</div>
...
<form action="crear_extras_para_postgres.php" method="post" id="adminForm" class="form-validate">
	<div id="installer">
		<div class="m">
			<h3>Extras para Postgres (Opcional)</h3>
		<!--
			<iframe src="gpl.htm" class="license" marginwidth="25" scrolling="auto"></iframe>
		-->
		<div class="install-text">
					Extras para Postgres (Opcional)
			</div>
