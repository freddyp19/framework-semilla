		...
		<div id="step">
			<div class="far-right">
				<div class="button1-right">
					<div class="prev"><a href="tablas_detalles.php" rel="prev" title="Previo">Previo</a></div>
				</div>
					<div class="button1-left">
					<div class="next">
					<a href="menu_tablas.php" rel="next" title="Siguiente">Siguiente</a>
					</div>
					</div>
			</div>
			<h2>Bienvenida</h2>
...
$(document).ready(function(){
	$("#btn_procesar").click(function(){
		...
		alert("para procesar"); 
		$.post("../modelo/abstraccion/creacion_modelo/tablas_observer.php", 
		{tabla_observer:$("#tabla_observer").val()}, function(data){
				...
				<div class="m">
					...
					?>
						<table class="content2 db-table" cellpadding="10">
							<tr>
								<td>Tabla Observer</td>
								<td bgcolor="#3333FF">
									<select id="tabla_observer">
